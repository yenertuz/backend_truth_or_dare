...
function check_if_the_room_has_enough_people($database, $room_id) {
...
$asker_user_object = get_asker_id_and_increment_asked_count($database, $_POST["room_name"]);
$asker_id = $asker_user_object["id"];
$asker_user_name = $asker_user_object["name"];
$replier_user_object = get_replier_id_and_increment_replied_count($database, $_POST["room_name"], $asker_id, $asker_user_name);
$replier_id = $replier_user_object["id"];
$replier_user_name = $replier_user_object["name"];

$room_description = update_room_status_and_asker_id_and_replier_id($database, $_POST["room_name"], $asker_id, $replier_id);
